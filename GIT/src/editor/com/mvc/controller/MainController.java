package editor.com.mvc.controller;
...
import editor.com.mvc.model.shapes.*;
import editor.com.mvc.view.GUI;
import editor.com.mvc.view.ShapeCreationBtn;
import editor.com.mvc.view.ShapeCreationButtonsPanel;
import editor.com.mvc.view.ShapeNameList;
import editor.com.mvc.view.ShapePropertiesPanel;
...
public class MainController {
    ...
    private class PaintSurface extends JComponent {
        ...
        public void setProperties(Shape shape, Point start, Point end) {
            ...
            }   else if (shape instanceof SpecialFigure) {
                prep.put("xAxis", end.getX() - start.getX());
