...
public class GUI extends JFrame {
    ...
    private final JLabel lblSnapshot = new JLabel("Screenshot");
    ...
    private final JMenu mnHelp = new JMenu("About");
    private final JMenuItem mntmAbout = new JMenuItem("Description");
    ...
    public GUI() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(GUI.class.getResource("/assets/logo_paint_brush.jpg")));
        setTitle("2D VECTOR GRAPHIC EDITOR");
        ...
        gl_ToolsPanel.setHorizontalGroup(
                gl_ToolsPanel.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(gl_ToolsPanel.createSequentialGroup()
                                .addGap(10)
                                .addGroup(gl_ToolsPanel.createParallelGroup(GroupLayout.Alignment.LEADING)
                                ...
                                .addGap(6)
                                .addGroup(gl_ToolsPanel.createParallelGroup(GroupLayout.Alignment.LEADING, false)
        ...
        gl_statusPanel.setHorizontalGroup(gl_statusPanel.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(gl_statusPanel.createSequentialGroup()
                        ...
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(mouseYlbl)
                        .addContainerGap(827, Short.MAX_VALUE)));
        gl_statusPanel.setVerticalGroup(gl_statusPanel.createParallelGroup(GroupLayout.Alignment.TRAILING)
                .addGroup(gl_statusPanel.createParallelGroup(GroupLayout.Alignment.BASELINE)
